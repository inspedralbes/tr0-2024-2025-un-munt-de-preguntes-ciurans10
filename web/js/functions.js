...
function enviarRespostes() {
    ...
    .then(data => {
        ...
        window.location.href = `http://localhost/tr0-2024-2025-un-munt-de-preguntes-ciurans10/web/php/finalitza.php?puntuacio=${data.puntuacio}&total=${arrayPreguntes.length}`;
    })
